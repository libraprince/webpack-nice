{
        ...
        /* config.module.rule('vue') */
        {
          ...
          use: [
            /* config.module.rule('vue').use('cache-loader') */
            {
              loader: 'cache-loader',
              options: {
                cacheDirectory: 'E:\\Goodtext\\hellovue\\node_modules\\.cache\\vue-loader',
                cacheIdentifier: '7f88e3e0'
              }
            },
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin(
        {
          ...
          template: 'E:\\Goodtext\\hellovue\\public\\index.html'
        }
      ),
      /* config.plugin('pwa') */
      new HtmlPwaPlugin(
      ...
      new CopyWebpackPlugin(
        [
          {
            from: 'E:\\Goodtext\\hellovue\\public',
            to: 'E:\\Goodtext\\hellovue\\dist',
            toType: 'dir',
            ignore: [
              '.DS_Store'
            ]
